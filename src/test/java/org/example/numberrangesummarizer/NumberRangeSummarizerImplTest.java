...
class NumberRangeSummarizerImplTest {
    ...
    void collect() {
        ...
        assertAll(
                ...
                // Test an input with duplicate values: should return the list without duplicate values in sorted order
                () -> assertEquals(expectedList, rs.collect("1,3,3,6,7,8,12,13,14,15,21,22,23,24,31")),
